        ...
        mSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                for (DatePickerDialogHandler handler : mDatePickerDialogHandlers) {
            	    ...
            	    int currYear = cal.get(Calendar.YEAR) - 18;
            	    //int currMonth = cal.get(Calendar.MONTH);
            	    //int currDay = cal.get(Calendar.DATE);
                	
                	if(mPicker.getYear() < 1900){
                		Toast.makeText(activity, "Please enter a valid date.", Toast.LENGTH_LONG).show();
                		return;
                	}else if(mPicker.getYear() > currYear){
                		Toast.makeText(activity, getResources().getString(R.string.age_validation_picker), Toast.LENGTH_LONG).show();
                		return;
                	}
