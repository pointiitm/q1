...
public class DateView extends PickerLinearLayout {
	...
	private static final String TAG = "BetterDatePickers/DateView";
    ...
    public DateView(Context context, AttributeSet attrs) {
        ...
        Log.d(TAG, "Inflating DateView");
        AssetManager manager = context.getAssets();
        try {
	        for (String assetPath:manager.list("")) {
        ...
        Log.d(TAG, "" + mAndroidClockMonoThin);
