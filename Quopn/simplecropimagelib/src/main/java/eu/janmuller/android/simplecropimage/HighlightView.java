...
class HighlightView {
    ...
    private void init() {
        ...
        mTopLeftEdge=
                resources.getDrawable(R.drawable.crop_edge_top_left);
        mTopRightEdge=
                resources.getDrawable(R.drawable.crop_edge_top_right);
        mBottomLeftEdge=
                resources.getDrawable(R.drawable.crop_edge_bottom_left);
        mBottomRightEdge=
                resources.getDrawable(R.drawable.crop_edge_bottom_right);
    }
...
//		mOutlinePaint.setColor(0xFFFF8A00);   
		mOutlinePaint.setColor(0xFFFFFFFF);   //sandeep this is rectangle  border color
            ...
            //Draw The Edges now
            mTopLeftEdge.setBounds(mDrawRect.left, mDrawRect.top,
            		mDrawRect.left + mTopLeftEdge.getIntrinsicWidth(),
            		mDrawRect.top + mTopLeftEdge.getIntrinsicHeight());
            mTopRightEdge.setBounds(mDrawRect.right - mTopRightEdge.getIntrinsicWidth(), 
            		mDrawRect.top,mDrawRect.right,
            		mDrawRect.top + mTopRightEdge.getIntrinsicHeight());
            mBottomLeftEdge.setBounds(mDrawRect.left, mDrawRect.bottom -mBottomLeftEdge.getIntrinsicHeight(),
            		mDrawRect.left + mBottomLeftEdge.getIntrinsicWidth(),
            		mDrawRect.bottom);
            mBottomRightEdge.setBounds(mDrawRect.right - mBottomRightEdge.getIntrinsicWidth(),
            		mDrawRect.bottom - mBottomRightEdge.getIntrinsicHeight() ,
            		mDrawRect.right,
            		mDrawRect.bottom);
            
            mTopLeftEdge.draw(canvas);
            mTopRightEdge.draw(canvas);
            mBottomLeftEdge.draw(canvas);
            mBottomRightEdge.draw(canvas);
    ...
    public void setup(Matrix m, Rect imageRect, RectF cropRect, boolean circle,
        ...
        //mOutlinePaint.setStrokeWidth(10F); //sandeep this is stroke width of outside rectangle.
    ...
    private Drawable mTopLeftEdge;
    private Drawable mTopRightEdge;
    private Drawable mBottomLeftEdge;
    private Drawable mBottomRightEdge;
