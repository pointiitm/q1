...
public class ProgressDialog extends android.app.Dialog{
	...
	@Override
	  ...
	  //  setTitle(title);
	    if(progressColor != -1){
	    	//original google code commented by siv
	    	...
	    	//siv
	    	ProgressBarCircularIndeterminate progressBarCircularIndeterminate = (ProgressBarCircularIndeterminate) findViewById(R.id.progressBarCircularIndetermininateQuopn);
