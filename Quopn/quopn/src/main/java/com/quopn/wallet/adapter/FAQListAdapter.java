...
public class FAQListAdapter extends BaseExpandableListAdapter {
	...
	private List<FAQData> _listDataHeader; // header titles
	...
	public View getChildView(int groupPosition, final int childPosition,
		...
		if (convertView == null) {
			...
			convertView = infalInflater.inflate(R.layout.faqlist_item, null);
		}
...
//		txtListChild.loadData(argData, "text/html", "utf-8");
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		FAQData headerTitle = (FAQData) getGroup(groupPosition);
		if (convertView == null) {
			LayoutInflater infalInflater = (LayoutInflater) this._context
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			convertView = infalInflater.inflate(R.layout.faqlist_group, null);
		}
...
//
//		mImgArrow = (ImageView) convertView.findViewById(R.id.arrow_faq);
//		if(isExpanded){
