...
public final class NetbankingFragment extends Fragment {
     ...
     */
    public static NetbankingFragment newInstance(QuopnConstants.PaymentType paymentType, Amount amount) {
    ...
    public static NetbankingFragment newInstance(QuopnConstants.DPRequestType dpRequestType, Amount originalAmount, String couponCode, Amount alteredAmount) {
        NetbankingFragment fragment = new NetbankingFragment();
