...
public class AppMessage {
     ...
     * stacking on top of any other {@link com.AppMessage.appmsg.AppMsg} with this duration.</p>
     *
     * <p><b>Note</b>: You are responsible
     * for calling {@link #cancel()} on such {@link com.AppMessage.appmsg.AppMsg}.</p>
     *
     * @see #setDuration
     */
     ...
     */
    public static final Style STYLE_ALERT = new Style(LENGTH_LONG, R.color.add_to_cart_bg_color);
     ...
     */
    public static final Style STYLE_INFO = new Style(LENGTH_SHORT, R.color.add_to_cart_bg_color);
    ...
    /**
     * Make a {@link AppMessage} that just contains a text view.
     *
...
//    }
    public static AppMessage makeText(Activity context, CharSequence text) {
        return makeText(context, text, STYLE_INFO, R.layout.app_msssage);
    }
...
//    }
    ...
    /**
     * Make a {@link AppMessage} with a custom layout. The layout must have a {@link TextView} com id {@link android.R.id.message}
     *
     * @param context The context to use. Usually your
     *                {@link android.app.Activity} object.
     * @param text    The text to show. Can be formatted text.
     * @param style   The style with a background and a duration.
     */
    public static AppMessage makeText(Activity context, CharSequence text, Style style, int layoutId) {
     ...
     * @param style   The style with a background and a duration.
     */
    public static AppMessage makeText(Activity context, CharSequence text, Style style, int layoutId, OnClickListener clickListener) {
        LayoutInflater inflate = (LayoutInflater)
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View v = inflate.inflate(layoutId, null);
     ...
     * @param style   The style with a background and a duration.
     */
    public static AppMessage makeText(Activity context, CharSequence text, Style style, int layoutId, float textSize, OnClickListener clickListener) {
        LayoutInflater inflate = (LayoutInflater)
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View v = inflate.inflate(layoutId, null);
     ...
     * @param style   The style with a background and a duration.
     */
    public static AppMessage makeText(Activity context, CharSequence text, Style style, int layoutId, float textSize) {
        LayoutInflater inflate = (LayoutInflater)
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View v = inflate.inflate(layoutId, null);
    ...
    /**
     * Make a non-floating {@link AppMessage} with a custom view presented inside the layout.
     ...
     * @param style    The style with a background and a duration.
     */
    public static AppMessage makeText(Activity context, CharSequence text, Style style, View customView) {
     ...
     * @param style    The style with a background and a duration.
     */
    public static AppMessage makeText(Activity context, CharSequence text, Style style, View customView, OnClickListener clickListener) {
       return makeText(context, text, style, customView, false, clickListener);
    }


    /**
     * Make a {@link AppMessage} with a custom view. It can be used to create non-floating notifications if floating is false.
     *
     * @param context  The context to use. Usually your
     *                 {@link android.app.Activity} object.
     * @param view
     ...
     */
    private static AppMessage makeText(Activity context, CharSequence text, Style style, View view, boolean floating) {
     ...
     * @param floating true if it'll float.
     */
    private static AppMessage makeText(Activity context, CharSequence text, Style style, View view, boolean floating, OnClickListener clickListener) {
     ...
     * @param floating true if it'll float.
     */
    private static AppMessage makeText(Activity context, CharSequence text, Style style, View view, boolean floating, float textSize) {
     ...
     * @param floating true if it'll float.
     */
    public static AppMessage makeText(Activity context, int resId, Style style, View customView, boolean floating) {
        return makeText(context, context.getResources().getText(resId), style, customView, floating);
    }

    /**
     * Make a {@link AppMessages} that just contains a text view with the text from a
     * resource.
     *
     * @param context The context to use. Usually your
     *                {@link android.app.Activity} object.
     ...
     */
//    public static AppMessages makeText(Activity context, int resId, Style style)
//            throws Resources.NotFoundException {
//        return makeText(context, context.getResources().getText(resId), style);
//    }

    /**
     * Make a {@link AppMessage} with a custom layout using the text from a
     ...
     * @throws Resources.NotFoundException if the resource can't be found.
     */
    public static AppMessage makeText(Activity context, int resId, Style style, int layoutId)
            throws Resources.NotFoundException {
     ...
     */
    public void show() {
        MessageManager manager = MessageManager.obtain(mActivity);
        manager.add(this);
    }

    /**
     * @return <code>true</code> if the {@link AppMessage} is being displayed, else <code>false</code>.
     */
     ...
     */
    public void cancel() {
        MessageManager.obtain(mActivity).clearMsg(this);

    }

    /**
     * Cancels all queued {@link AppMessage}s, in all Activities. If there is a {@link AppMessage}
    ...
    /**
     * Cancels all queued {@link AppMessage}s, in given {@link android.app.Activity}.
     * If there is a {@link AppMessage} displayed currently, it will be the last one displayed.
     * @param activity
     */
    ...
    /**
     * The style for a {@link AppMessage}.
     *
     * @author e.shishkin
     */
    public static class Style {
        ...
        /**
         * Construct an {@link AppMessage.Style} object.
         *
        ...
        public boolean equals(Object o) {
            if (!(o instanceof AppMessage.Style)) {
                return false;
            }
            Style style = (Style) o;
