...
public class FAQActivity extends ActionBarActivity implements ConnectionListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.faqmenu);
...
//		return rootView;
	...
	public void getFAQs(){
		...
		mConnectionFactory.createConnection(QuopnConstants.FAQ);
	 ...
	 @Override
		...
		// preparing list data
				...
				mFAQList.setOnGroupClickListener(new OnGroupClickListener() {
		...
		runOnUiThread(new Runnable() {
			...
			public void run() {
				if (mCustomProgressDialog != null && mCustomProgressDialog.isShowing()) {
					mCustomProgressDialog.dismiss();
					Dialog dialog=new Dialog(FAQActivity.this, R.string.slow_internet_connection_title,R.string.slow_internet_connection); 
					dialog.show();
				}
