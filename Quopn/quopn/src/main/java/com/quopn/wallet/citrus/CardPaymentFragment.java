...
public class CardPaymentFragment extends Fragment {
    ...
    public static CardPaymentFragment newInstance(QuopnConstants.PaymentType paymentType, Amount amount) {
    ...
    public static CardPaymentFragment newInstance(QuopnConstants.DPRequestType dpRequestType, Amount originalAmount, String couponCode, Amount alteredAmount) {
        CardPaymentFragment fragment = new CardPaymentFragment();
        Bundle bundle = new Bundle();
