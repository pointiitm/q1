...
public class UCNNumberRequest extends ConnectRequest implements Connector,RequestTimer.RequestTimerListener {
	private static final String TAG="UCNNumberRequest";
	private UCNNumberData mResponseUCNNumber;
	private RequestTimer requestTimer;
	public UCNNumberRequest(Context mContext,
...
//							}
	...
	public void parseJson(String data) {
		...
		try {
			Gson gson = new Gson();
			mResponseUCNNumber= (UCNNumberData) gson.fromJson(data,UCNNumberData.class);
//			Log.v(TAG,"ResponseOk");
			this.mConnectionListener.onResponse(ConnectionListener.RESPONSE_OK,mResponseUCNNumber);
