...
public class RemoveFromCartRequest extends ConnectRequest implements Connector,RequestTimer.RequestTimerListener {
	private static final String TAG="Quopn/RemoveFromCartRequest";
	private RemoveFromCartData mResponseRemoveFromCart;
	private RequestTimer requestTimer;
	
	public RemoveFromCartRequest(Context mContext,ConnectionListener connectionListener) {
...
//							}
	...
	public void parseJson(String data) {
		try {
			Gson gson = new Gson();
			mResponseRemoveFromCart= (RemoveFromCartData) gson.fromJson(data,RemoveFromCartData.class);
			mConnectionListener.onResponse(ConnectionListener.RESPONSE_OK,mResponseRemoveFromCart);
