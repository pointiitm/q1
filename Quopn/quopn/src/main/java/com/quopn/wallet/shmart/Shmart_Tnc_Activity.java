...
public class Shmart_Tnc_Activity extends ActionBarActivity implements ConnectionListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shmart_tnc);
        mAnalysisManager = ((QuopnApplication) getApplicationContext()).getAnalysisManager();
        mAnalysisManager.send(AnalysisEvents.SCREEN_WALLET_TNC);
...
//        });
    ...
    public void getFAQs(){
        if (QuopnUtils.isInternetAvailable(this)) {
            ...
            mConnectionFactory.createConnection(QuopnConstants.QUOPN_MOBILE_WALLET_TNC);
    ...
    protected void onResume(){
        ...
        mFAQList.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            ...
            public boolean onGroupClick(ExpandableListView parent, View v,
                ...
                if(QuopnUtils.isInternetAvailable(Shmart_Tnc_Activity.this)){
                    ...
                    new Dialog(Shmart_Tnc_Activity.this,R.string.dialog_title_no_internet,R.string.please_connect_to_internet).show();
                }
                return false;
            }
        });
    ...
    private void prepareListData() {
        ...
        listDataHeader.add(new FAQData("TNC",R.drawable.icon_faq));
...
//        FAQs.add(QuopnApi.QUOPN_MOBILE_WALLET_TNC_URL_SHMART);
        if (QuopnApplication.getInstance().getCurrentWalletMode() == QuopnConstants.WalletType.SHMART) {
            ...
            FAQs.add(QuopnApi.QUOPN_MOBILE_WALLET_TNC_URL_CITRUS);
        }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (mCustomProgressDialog != null && mCustomProgressDialog.isShowing()) {
                    mCustomProgressDialog.dismiss();
                    Dialog dialog=new Dialog(Shmart_Tnc_Activity.this, R.string.slow_internet_connection_title,R.string.slow_internet_connection);
                    dialog.show();
                }
