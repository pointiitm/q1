...
public class NotifyIdSentRequest extends ConnectRequest implements Connector, RequestTimer.RequestTimerListener {
	private static final String TAG="NotifyIdSentRequest";
	private NotifyStatusData mResponseNotifyStatus;
	private RequestTimer requestTimer;
	
	public NotifyIdSentRequest(Context mContext,
...
//							}
	...
	public void parseJson(String data) {
		try {
			Gson gson = new Gson();
			mResponseNotifyStatus = (NotifyStatusData) gson.fromJson(data,NotifyStatusData.class);
//			Log.v(TAG,"ResponseOk");
			mConnectionListener.onResponse(ConnectionListener.RESPONSE_OK,mResponseNotifyStatus);
