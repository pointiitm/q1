...
public class CreditDebitCardFragment extends Fragment implements View.OnClickListener {
    ...
    public static CreditDebitCardFragment newInstance(QuopnConstants.PaymentType paymentType, CType cType, Amount amount) {
    ...
    public static CreditDebitCardFragment newInstance(QuopnConstants.DPRequestType dpRequestType, CType cType, Amount originalAmount, String couponCode, Amount alteredAmount) {
        CreditDebitCardFragment fragment = new CreditDebitCardFragment();
        Bundle bundle = new Bundle();
...
//            }
            ...
            try {
                if (this.paymentType == QuopnConstants.PaymentType.LOAD_MONEY) {
                ...
                } else if (this.paymentType == QuopnConstants.PaymentType.PG_PAYMENT) {
                ...
                } else if (this.paymentType == QuopnConstants.PaymentType.DYNAMIC_PRICING) {
                    Logger.e("DYNAMIC_PRICING is not handled");
